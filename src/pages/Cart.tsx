  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="font-display text-3xl text-gray-800 mb-8">Shopping Cart ({totalItems} items)</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              ...
              >
                {/* Product Image */}
                <Link to={`/product/${item.id}`} className="w-24 h-24 sm:w-32 sm:h-32 bg-gray-50 rounded-lg flex-shrink-0 flex items-center justify-center p-2">
                  <img
                    src={item.image}
                    alt={item.name}
            ...
            <button
              onClick={clearCart}
              className="text-gray-500 hover:text-red-500 font-body text-sm flex items-center gap-2 transition-colors"
            >
              <Trash2 size={16} />
              Clear Cart
            </button>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 sticky top-24">
              ...
              <button
                ...
                className="w-full bg-brand-blue text-white font-body font-semibold py-4 rounded-full hover:bg-brand-dark transition-colors mb-4"
              >
                Proceed to Checkout
              </button>
              ...
              <Link
                to="/"
                className="w-full block text-center text-gray-500 hover:text-gray-700 font-body transition-colors"
              >
                Continue Shopping
              </Link>
